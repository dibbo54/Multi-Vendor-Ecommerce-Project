            ...
            <form method="post" action="{{ route('update.product.thambnail') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <img id="imagePreview" src="{{ asset($products->product_thambnail) }}"
                    ...
                    <tbody>
                        ...
                        <form method="post" action="{{ route('update.product.multiimage') }}"
                            ...
                            @foreach ($multiImgs as $key => $img)
                                ...
                                {{-- <tr>
                                    <th scope="row">{{ $key + 1 }}</th>
                                    <td> <img id="previewImage{{ $key }}" src="{{ asset($img->photo_name) }}" style="width:70px; height:40px;"> </td>
                                    <td> <input type="file" class="form-group" name="multi_img[{{ $img->id }}]" onchange="previewImage(event, '{{ $key }}')"> </td>
                                    <td>
                                        <input type="submit" class="btn btn-primary px-4" value="Update Image" />
