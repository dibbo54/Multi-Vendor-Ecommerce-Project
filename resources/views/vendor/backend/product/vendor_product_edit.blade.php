    ...
    <div class="page-content">
        ...
        {{ $products->short_descp }}
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea id="inputProductDescription" name="long_descp" class="form-control">
				 {!! $products->long_descp !!}</textarea>
                                    </div>

                                    {{-- <div class="form-group mb-3">
                <label for="inputProductDescription" class="form-label">Long Description</label>
                <textarea id="inputProductDescription" name="long_descp" class="form-control">Hello, World!</textarea>
            </div> --}}
