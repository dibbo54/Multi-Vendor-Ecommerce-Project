...
<div class="header-notifications-list">
 ...
 @php
 $route = '';
 if ($notification->data['message'] == 'New Order Added in Shop') {
     $route = route('pending.order');
 } if ($notification->data['message'] == 'New Vendor Request') {
      $route = route('inactive.vendor');
 }
 if ($notification->data['message'] == 'New User Register In Shop') {
      $route = route('all-user');
 }
 
 //New User Register In Shop
@endphp
