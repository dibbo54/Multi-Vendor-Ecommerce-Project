...
@php
    ...
    //$coupons = App\Models\Coupon::where('', '>=', Carbon\Carbon::now())->get();
@endphp
        ...
        function miniCart() {
            ...
            <li>
                <div class="shopping-cart-img">
                    <a href="{{ route('mycart') }}"><img href="{{ route('mycart') }} alt="Nest" src="/${value.options.image} " style="width:50px;height:50px;" /></a>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.wishlist, function(key, value) {
                        var productDetailUrl = `{{ url('/product/details/:id/:slug') }}`.replace(':id', value.id).replace(':slug', value.product.product_slug);
                        ...
                        <td class="product-des product-name">
                            <h6><a class="product-name mb-10" href="${productDetailUrl}">${value.product.product_name} </a></h6>
